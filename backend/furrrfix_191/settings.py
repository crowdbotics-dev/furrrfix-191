"""
Django settings for furrrfix_191 project.
...
ROOT_URLCONF = 'furrrfix_191.urls'
...
WSGI_APPLICATION = 'furrrfix_191.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "furrrfix_191 API",
    "DESCRIPTION": "API documentation for furrrfix_191 App",
    "VERSION": "v1",
}
